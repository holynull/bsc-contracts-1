...
const proxyContract: BStableProxyV2DeflationContract = artifacts.require('BStableProxyV2.sol');
const stableCoinContract: StableCoinContract = artifacts.require('StableCoin.sol');
const tokenContract: BStableTokenV2DeflationContract = artifacts.require('BStableTokenV2.sol');
